...
public class MoveBehaviour : GenericBehaviour
{
    ...
    void Start()
    {
        ...
        // Teleport to ground in case of spawning underground.
        // Find the ground and move the player to it.
        RaycastHit hit;
        if (Physics.Raycast(transform.position + Vector3.up, Vector3.down, out hit, 5f, LayerMask.GetMask("Default")))
        {
